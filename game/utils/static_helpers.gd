...
"""
Map passed value from first provided range into second provided range
keeping relative value scale
Example: a 3-star rating in a 5-star rating system maps to a 10-point system:
mapval(3, 1, 5, 1, 10) => 6
"""	
